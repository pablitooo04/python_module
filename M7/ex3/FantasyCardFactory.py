...
class FantasyCardFactory(CardFactory):
    ...
    Provides methods to create creatures, spells, and artifacts with fantasy-themed attributes.
    Also includes a method to create a themed deck of cards and retrieve supported types.
    """
    cards = {'artifacts': [
    ...
    def create_creature(self, name_or_power: str=None) -> Card:
        ...
        Args:
            name_or_power (str, optional): The name of the creature to create.
        Returns:
            Card: An instance of CreatureCard with the specified attributes.
        Raises:
            ValueError: If the provided name does not match any available creature.
        """
    ...
    def create_spell(self, name_or_power: str=None) -> Card:
        ...
        Raises:
            ValueError: If the provided name does not match any available spell.
        """
    ...
    def create_artifact(self, name_or_power: str=None) -> Card:
        ...
        Raises:
            ValueError: If the provided name does not match any available artifact.
        """
    ...
    def create_themed_deck(self, size: int) -> dict:
        """
        Creates a themed deck of cards with a specified size. The deck is randomly generated
        with a mix of creatures, spells, and artifacts. The method also counts the occurrences
        of each card in the hand for reporting purposes.
        Args:
            size (int): The number of cards to include in the deck.
        Returns:
            dict: A dictionary containing the hand (card counts) and the deck (list of card
            instances).
        Raises:
    ...
    def get_supported_types(self) -> dict:
        """
        Returns a dictionary of supported card types and their corresponding attributes.
        This method provides information about the types of cards that can be created by the factory,
        including their attributes and effects.
        Returns:
            dict: A dictionary containing the supported card types and their attributes.
        """
